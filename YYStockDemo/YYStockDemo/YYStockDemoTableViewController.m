...
/**
 K线数据源
 */
@property (strong, nonatomic) NSMutableDictionary *stockDatadict; /** < 请求的数据，根据key的不同存放数据*/
@property (copy, nonatomic) NSArray *stockDataKeyArray;           /** <  用来区别分时、日K的字符串Key*/
@property (copy, nonatomic) NSArray *stockTopBarTitleArray;       /** < 上面显示分时 、日K的标题*/
@property (strong, nonatomic) YYFiveRecordModel *fiveRecordModel; /** < 展示买卖的5条记录*/
...
@property (strong, nonatomic) IBOutlet UIView *stockContainerView;/** < 用来添加stock的父View*/
